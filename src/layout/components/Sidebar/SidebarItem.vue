<template>
  ...
  <div v-if="!item.hidden && item.meta && this.userAllMenus.indexOf('|'+item.meta.accessCode+'|') != -1">
...
export default {
  ...
  created() {
    this.userAllMenus = this.$store.getters.menus
    console.log('userMenus --- 请求菜单', this.userAllMenus)
  },
  methods: {
